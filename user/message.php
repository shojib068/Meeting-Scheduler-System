...
<?php
	...
	{
		mysqli_query($db,"INSERT into message VALUES ('','$_SESSION[login_user]','$_POST[message]','no','user');");

		$res=mysqli_query($db,"SELECT * from message where email='$_SESSION[login_user]' ;");
	...
	mysqli_query($db,"UPDATE message set status='yes' where sender='admin' and email='$_SESSION[login_user]' ;");
?>
