 ...
 if (isset($_POST['create_meeting']))
{
  ...
  if($selected_meeting ==='meeting5')

  {
    $title= 'Others';
    $description='This is demo 5';
  }
  ...
  elseif ($selected_meeting === 'meeting4')
   {
   
    $title = 'Planning';
    $description = 'This is demo 4';
  }
  elseif ($selected_meeting === 'meeting3')
  {
...
<form  class="form-control" name="call_meeting" action="" method="POST">
       ...
       <br>
          ...
          <select id="meeting_type" name="meeting_type" class="form-select">
            ...
            <option  value="meeting3">Academic</option>
            <option  value="meeting4">Planning</option>
            <option  value="meeting5">Others</option>
          </select>
