...
<body>
  ...
  <div class="reg_img">
    ...
    <div class="box2">
        <h1 class="heading"> Admin Registration Form</h1>
...
if(isset($_POST['submit']))
{
  ...
  if($count==0)
  {
    mysqli_query($db,"INSERT INTO admin_login ( `firstname`, `lastname`, `username`, `email`, `password`,'status')VALUES('$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[email]','$_POST[password]','')");
  ?>
  ...
  else
  {
    ...
    ?>
      <script type="text/javascript">
        alert("The admin already exists!!!.");
      </script>
    <?php
