...
<body style="background-color: #004528;">
	...
	<?php
		...
		$sql = "SELECT * FROM admin_login WHERE email='$_SESSION[login_user]'";
	...
	<?php 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql1= "UPDATE admin_login SET  firstname='$first', lastname='$last', username='$username', password='$password', email='$email' WHERE email='".$_SESSION['login_user']."';";
